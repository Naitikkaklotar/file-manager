	...
	<div id="layout-wrapper">
		...
		<div class="main-content">
			...
			<div class="page-content">
				...
				<<%-- div class="row"> <div class="col-12"> <div class="card"> <div
				class="card-body"> <table id="datatable" class="table table-bordered
				dt-responsive nowrap w-100"> <thead> <tr> <th>#</th> <th>State
				Name</th> <th>Description</th> <th>Action</th> </tr> </thead>

				<tbody> <c:forEach items="${stateList}" var="i" varStatus="j"> <tr>
				<td>${j.count}</td> <td>${i.state_name}</td>
				<td>${i.description}</td> <td><a class="btn-outline-primary"
				href="javascript:void(0)" onclick="handleClickOfEdit('${i.id}')"> <i
				class="fas fa-pencil-alt"></i></a>&nbsp;&nbsp; <a
				class="delete-icon-color" href="deleteUser?id=${i.id}"> <i
				class="fas fa-trash-alt"></i> </a></td> </tr> </c:forEach> </tbody>

				</table> </div> </div> </div> <!-- end col --> </div> <!-- end row
				--> --%>
				...
				<div class="modal-body">
					<f:form id="myForm" action="saveCity" method="post"
						...
						<div class="mb-3">
							...
							<f:input type="text" class="form-control" id="id"
								path="id" name="id" />
						</div> --%>
