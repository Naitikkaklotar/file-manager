		...
		<div class="d-flex">
			...
			<div class="navbar-brand-box">
				<a href="index.html" class="logo logo-dark"> <span
					class="logo-sm"> <img
						src="<%=request.getContextPath()%>/adminResource/images/logo.svg"
						alt="" height="22" />
				</span> <span class="logo-lg"> <img
						src="<%=request.getContextPath()%>/adminResource/images/logo-dark.png"
						alt="" height="17" />
				</span>
		...
		<div class="d-flex">
				...
				<div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0"
					...
					<div data-simplebar style="max-height: 230px">
						<a href="javascript: void(0);"
							...
							<div class="d-flex">
								<img
									src="<%=request.getContextPath()%>/adminResource/images/avatar-3.jpg"
							...
							<div class="d-flex">
								<img
									src="<%=request.getContextPath()%>/adminResource/images/avatar-4.jpg"
									class="me-3 rounded-circle avatar-xs" alt="user-pic" />
								<div class="flex-grow-1">
			...
			<div class="dropdown d-inline-block">
				...
				<div class="dropdown-menu dropdown-menu-end">
					<!-- item-->
					<span class="d-none d-xl-inline-block ms-1"><%=Basemethods.getUsername()%></span>
